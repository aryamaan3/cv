...
\begin{itemize}
\item
	\ressubheadinga{Master 1 MIAGE}{Sophia Antipolis}
	\ressubheadingb{Université Côte d'Azur}{À partir de Septembre 2021}
	\begin{itemize}
		\resitem{Science de données, Bases de données, Systèmes }
	\end{itemize}
...
\textbf{Langages:} Python, JavaScript, C/C++, Java, R. \textbf{Frameworks:} PyTorch, TensorFlow, React, Node, Vue. \linebreak \textbf{Bilingue:} Ayant comme langue maternelle l'Anglais
